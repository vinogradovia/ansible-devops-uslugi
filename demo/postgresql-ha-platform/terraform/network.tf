# ADR-0006 §2: одна плоская сеть на весь стенд, включая postgres-dr-replica — второй сегмент с
# WireGuard/IPsec-туннелем (более точная имитация топологии ADR-0004 §5) сознательно не делается.
#
