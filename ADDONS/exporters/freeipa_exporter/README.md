...
| `ipa_bind` | Anonymous BIND status (1=ON, 0=OFF) (only freeipaserver_original) |
...
|-------------|-------------|--------|
| `ipa_replication_status` | Replication status (0=OK, 1=Error) (only freeipaserver_original) | `source`, `target` |
